...
public class AddFileToTheFolder_Step_Definitions {
    ...
    public void user_choose_a_folder_from_the_page() {
        for (WebElement each: manageFoldersPage.filesListInfo){
...
manageFoldersPage.AddingBtn.click();
    }
    @When("the user uploads a file with the upload file option")
    public void the_user_uploads_a_file_with_the_upload_file_option() {

        manageFoldersPage.uploadFileLink.sendKeys("/Users/angelinabulgakova/Desktop/" + fileName);
    }
